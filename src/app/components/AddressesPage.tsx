        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-emerald-600 dark:bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-emerald-700 dark:hover:bg-emerald-700 transition-colors"
            >
